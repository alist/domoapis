...
(function() {
  ...
  zappa.app = function() {
    var a, app, apply_helpers, client, client_bundle_simple, client_bundled, context, func, helpers, io, options, partials, postrenders, real_root, request_socket, root, route, socket_session, verb, ws_handlers, zappa_prefix, zappa_used, _fn, _i, _j, _len, _len1, _ref2, _ref3;
    ...
    context.use = function() {
      ...
      zappa_middleware = {
        ...
        staticGzip: function(options) {
          ...
          console.error('staticGzip middleware is deprecated, please investigate using\nstandard `compress` and `staticCache` middleware instead');
          if (typeof options === 'string') {
            options = {
              path: options
            };
    ...
    if (io != null) {
      ...
      context.get(zappa_prefix + '/socket/:channel_name/:socket_id', function() {
        var channel_name, io_client, io_data, key, socket_id, _base, _ref4;

        if (this.session != null) {
          channel_name = this.params.channel_name;
          socket_id = this.params.socket_id;
          if ((_ref4 = (_base = this.session).__socket) == null) {
            _base.__socket = {};
          }
